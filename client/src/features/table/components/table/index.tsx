...
export const Table: React.FC<TableProps> = ({ rows, columns, isLoading, onUpdateData }) => {
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-r from-violet-200 to-pink-200 p-4 flex flex-col font-sans text-gray-900">
      <div className="flex-1 flex flex-col bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200/60 ring-1 ring-gray-900/5">
        {/* 1. App Header */}
        ...
        <div ref={parentRef} className="flex-1 overflow-auto bg-[#f9f9f9] relative">
        ...
        {/* Footer / Status Bar */}
        <div className="h-8 border-t border-gray-200 bg-white flex items-center px-4 text-xs text-gray-500 justify-between z-20 bg-gray-50">
